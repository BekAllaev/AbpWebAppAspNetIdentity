...
namespace BookStore.Blazor.Account
{
    ...
    internal sealed class IdentityRevalidatingAuthenticationStateProvider : RevalidatingServerAuthenticationStateProvider
    {
            ...
            AuthenticationState authenticationState, CancellationToken cancellationToken)
        {
            ...
            var userManager = scope.ServiceProvider.GetRequiredService<UserManager<BookStoreIdentityUser>>();
            return await ValidateSecurityStampAsync(userManager, authenticationState.User);
        }

        private async Task<bool> ValidateSecurityStampAsync(UserManager<BookStoreIdentityUser> userManager, ClaimsPrincipal principal)
        {
